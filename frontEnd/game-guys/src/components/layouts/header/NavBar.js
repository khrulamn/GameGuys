            ...
            <div className='flex justify-between items-center w-1/2'>
                <div className=' w-4/5'>
                    <ul className='grid grid-cols-4 text-white font-main items-center font-medium text-2xl ml-28 mt-6'>
                        <li><a className="hover:cursor-pointer hover:text-tertiaryColor" href={url}>News</a></li>
                        <li><a className="hover:cursor-pointer hover:text-tertiaryColor" href={url} >Shop</a></li>
                        <li><a className="hover:cursor-pointer hover:text-tertiaryColor" href={url} >Search</a></li>
                        <li><button className="hover:cursor-pointer hover:text-tertiaryColor" onClick={() => props.cartHandler()}>Cart</button></li>
                    </ul>
                </div>
