            ...
            <div className="p-11">
                ...
                <div className="flex justify-between items-center mt-3">
                    ...
                    <button data-tip="More info" onClick={showConsoleHandler}>
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-9 w-9 hover:stroke-white stroke-tertiaryColor  ease-linear transition-all duration-150" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
